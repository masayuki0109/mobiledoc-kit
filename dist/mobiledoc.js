...
class Marker extends Markerupable {
...
const postOpcodeCompiler$2 = {
  openMarker(closeCount, value) {
    this.markupMarkerIds = [];
    this.markers.push([MOBILEDOC_MARKUP_MARKER_TYPE$1, this.markupMarkerIds, closeCount, value || '']);
  },
  openMarkupSection(tagName) {
    this.markers = [];
  ...
  openAtom(closeCount, name, value, payload) {
    const index = this._addAtomTypeIndex(name, value, payload);
    this.markupMarkerIds = [];
    this.markers.push([MOBILEDOC_ATOM_MARKER_TYPE$1, this.markupMarkerIds, closeCount, index]);
  },
  openPost() {
    this.atomTypes = [];
    this.cardTypes = [];
...
const postOpcodeCompiler$3 = {
  openMarker(closeCount, value) {
    this.markupMarkerIds = [];
    this.markers.push([MOBILEDOC_MARKUP_MARKER_TYPE$2, this.markupMarkerIds, closeCount, value || '']);
  },
  ...
  openAtom(closeCount, name, value, payload) {
    const index = this._addAtomTypeIndex(name, value, payload);
    this.markupMarkerIds = [];
    this.markers.push([MOBILEDOC_ATOM_MARKER_TYPE$2, this.markupMarkerIds, closeCount, index]);
  },
  openPost() {
    this.atomTypes = [];
    this.cardTypes = [];
...
var CARD_MODES;
(function (CARD_MODES) {
    CARD_MODES["DISPLAY"] = "display";
    CARD_MODES["EDIT"] = "edit";
...
class Card extends Section {
    constructor(name, payload) {
        super(CARD_TYPE);
        this._initialMode = CARD_MODES.DISPLAY;
        this.name = name;
        this.payload = payload;
        this.isCardSection = true;
    }
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    isValidTagName(_normalizedTagName) {
...
const VALID_MARKUP_SECTION_TAGNAMES = ['aside', 'blockquote', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p'].map(
  normalizeTagName
);
...
// tagName
const MARKUP_SECTION_ELEMENT_NAMES = ['aside', 'blockquote', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p'].map(
  normalizeTagName
);
...
export { Editor, MobiledocError as Error, ImageCard, MOBILEDOC_VERSION$4 as MOBILEDOC_VERSION, Position, Range, ui as UI, version as VERSION };
